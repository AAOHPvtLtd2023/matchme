...
export default function ProfileScreen({ navigation }) {
  ...
  //  // Define the function to be called on long press
  const handleLongPress = () => {
    const img = user.profilePicsURLs;
    navigation.navigate('userPhoto', { img });
    // Navigate to another page using the navigation prop
  };
        ...
        >
          ...
          {user &&
            <ScrollView style={{ height: "100%", width: "100%" }}>
              <Animatable.View animation="fadeIn" style={Mainstyles.upper}>

                {/* profile Pic */}
                <View style={Mainstyles.imageArea}>
                  <Pressable onLongPress={() => { handleLongPress() }} style={{ height: '100%', width: '100%' }} >
                    <Image
                  ...
                  <View style={{ width: "80%" }}>
                    ...
                    >
                      ...
                      >
                        ...
                        <Text style={{ fontSize: 15, fontFamily: 'custom1' }}>{user.formData.age}</Text>
                      </Animatable.View>
                      <Animatable.View
                        animation="fadeIn"
                        delay={1000}
                      ...
                      >
                        ...
                        <Text style={{ fontSize: 15, marginLeft: 5, fontFamily: 'custom1' }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <Image
                      source={{ uri: user.profilePicsURLs[1] }}
                      resizeMode="cover"
              ...
              >
                ...
                >
                  ...
                  >
                    <Image
                      source={{ uri: user.profilePicsURLs[2] }}
                      resizeMode="cover"
                      style={{ height: "100%", width: "100%", opacity: 0.7 }}
                    />
                    {/* Communication style  */}
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {user.formData.communicationStyle || 'not given'}
                          </Text>
                        </View>
                      </View>
                    </View>
